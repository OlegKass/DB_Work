...
VALUES(160, 'Jacobus Henricus vant Hoff1', 'Male', 1901, '"in recognition of the extraordinary services he has rendered by the discovery of the laws of chemical dynamics and osmotic pressure in solutions"', TO_DATE('1853-08-30', 'YYYY-MM-DD'), TO_DATE('1911-03-01', 'YYYY-MM-DD'),'Berlin University','Chemistry');
INSERT INTO Laureat(laureat_id, full_name, sex, reward_year, motivation, birth_date, death_date, org_name, Category_name)
